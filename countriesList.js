    ...
    .then((response) => (response.json())
      .then(function (responseData) {
        ...
        for (let country = 0; country < responseData.length; country++) {
          // countries[data[country]["Country"]] = countries[country]["Slug"]
        ...
        // countries.sort()
        // console.log(countries.slice(0,99));
        // console.log(countries.slice(100,199));
        // console.log(countries.slice(200,248));
      })
    )
};
